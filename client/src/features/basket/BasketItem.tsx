import { Box, Paper, Typography, Grid2, IconButton } from '@mui/material';
...
export default function BasketItem({item}:Props) {
    ...
    const [addBasketItem] = useAddItemToBasketMutation();
  return (
    <Paper sx={{
        height:140,
        borderRadius:3,
       ...
       <Box display='flex' alignItems='center'>
            ...
            src={item.pictureUrl}
            alt={item.name}
            sx={{height:100, width:100, objectFit:'cover', borderRadius:'4px', mr:8,ml:4}}/>
            ...
            <Grid2 container spacing={1}  alignItems='center' >
                <IconButton onClick={()=>removeBasketItem({productId:item.productId,quantity:1})}
